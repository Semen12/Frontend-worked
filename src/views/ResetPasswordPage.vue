    ...
    <form class="password-reset__form" @submit.prevent="resetPassword">
      <div class="password-reset__form-group">
        ...
        <div class="password-reset__input-container">
          <input :type="ShowPassword ? 'text' : 'password'" @input="validatePassword" id="password" v-model="password"
            class="password-reset__input" required />
      ...
      <div class="password-reset__form-group">
        ...
        <div class="password-reset__input-container">
          <input :type="showConfirmPassword ? 'text' : 'password'" @input="validatePasswordConfirm"
            id="password_confirmation" v-model="password_confirmation" class="password-reset__input" required />
