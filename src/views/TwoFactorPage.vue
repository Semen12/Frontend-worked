  ...
  <div class="two-factor">
    ...
    <form class="two-factor__form" @submit.prevent="verifyCode">
      <div class="two-factor__form-group">
        ...
        <input v-if="!showRecoveryCodeInput" type="text" id="code" v-model="code" class="two-factor__input"
          @input="validateCode" required />
        <input v-else type="text" id="recovery_code" v-model="recovery_code" class="two-factor__input"
          @input="validateCode" required />
